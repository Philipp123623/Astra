    ...
    async def init_tables(self):
        ...
        async with self.pool.acquire() as conn:
            async with conn.cursor() as cur:
                ...
                await cur.execute("CREATE TABLE topgg (userID BIGINT PRIMARY KEY, count INT NOT NULL DEFAULT 0, last_reset DATE NULL, last_vote DATETIME NULL, last_vote_epoch BIGINT NULL, next_vote_epoch BIGINT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;")
