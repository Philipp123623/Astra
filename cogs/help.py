...
class HelpCog(commands.Cog):
    ...
    def _build_pages(self):
        self.pages = {
            ...
            "Eco": f"> <:Astra_support:1141303923752325210> Verdiene und verwalte virtuelles Geld. Spiele, arbeite oder handle mit anderen Usern.\n\n> **👥 × User Befehle:**\n> </economy balance:{self._cid('economy')}> - {self._cdesc('economy balance')}\n> </economy deposit:{self._cid('economy')}> - {self._cdesc('economy deposit')}\n> </economy withdraw:{self._cid('economy')}> - {self._cdesc('economy withdraw')}\n> </economy leaderboard:{self._cid('economy')}> - {self._cdesc('economy leaderboard')}\n> </economy beg:{self._cid('economy')}> - {self._cdesc('economy beg')}\n> </economy rob:{self._cid('economy')}> - {self._cdesc('economy rob')}\n> </economy rps:{self._cid('economy')}> - {self._cdesc('economy rps')}\n> </economy slot:{self._cid('economy')}> - {self._cdesc('economy slot')}\n> </economy coinflip:{self._cid('economy')}> - {self._cdesc('economy coinflip')}\n> </economy blackjack:{self._cid('economy')}> - {self._cdesc('economy blackjack')}\n> </job list:{self._cid('job')}> - {self._cdesc('job list')}\n> </job apply:{self._cid('job')}> - {self._cdesc('job apply')}\n> </job quit:{self._cid('job')}> - {self._cdesc('job quit')}\n> </job work:{self._cid('job')}> - {self._cdesc('job work')}\n\n> **👮‍♂ × Team Befehle:**\n> Keine Team Befehle.",
