...
async def button2(interaction: discord.Interaction):
    ...
    view.timeout = None
    embed = discord.Embed(title="Command Menu", description="Select a category to start!", colour=discord.Colour.blue())
    embed.set_author(name="Astra Command Menu", icon_url=interaction.client.user.avatar)
    embed.set_footer(
        text=f"All rights reserved ©2022 Astra Development | For more informations contact us via discord")
    embed.set_image(
