...
class SetupWizardView(discord.ui.View):
    ...
    def build_embed(self) -> discord.Embed:
        ...
        lines.append(f"\n\n<:Astra_wichtig:1141303951862534224> **Wichtig:** Um unseren Bot und eure Discord-Server vor [<:Astra_url:1141303937056657458> **Ratelimits**](https://discord.com/developers/docs/topics/rate-limits) zu schützen,\nkönnen nur User mit der Supportrolle, Tickets schließen.")
